...
var CardDetails = function (_a) {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement(material_1.Dialog, { open: isOpen, onClose: handleCloseDialog, "aria-labelledby": 'responsive-dialog-title', maxWidth: 'xs' },
            react_1["default"].createElement("div", { className: page_module_css_1["default"].title__container },
                react_1["default"].createElement(material_1.Grid, { container: true, justifyContent: 'center', alignItems: 'center' },
                    react_1["default"].createElement(material_1.Grid, { item: true, xs: 12, md: 4 },
                        react_1["default"].createElement("div", { className: page_module_css_1["default"].card__image },
