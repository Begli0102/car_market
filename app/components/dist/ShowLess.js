...
var ShowLess = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: page_module_css_1["default"].show__more__container },
        react_1["default"].createElement(material_1.Box, { textAlign: 'center' },
            react_1["default"].createElement(material_1.Chip, { sx: { minWidth: '280px' }, label: 'Show less', color: 'secondary', onClick: handleShowLess }))));
};
exports["default"] = ShowLess;
